...
function TwentyFive({
  ...
  return (
    ...
    >
      ...
      >
        <Box
          sx={{ width: "150px", height: "75px", backgroundColor: "red" }}
        >
          <img
            style={{
              width: "100%",
      ...
      <Stack
        ...
        alignItems={"center"}
      >
        <Box py={2} bgcolor={"#fddfe094"}  width={"100%"} justifyItems={"center"}>
      ...
      <Stack boxSizing={'border-box'} pb={0.5} px={1} direction={"row"} justifyContent={'space-between'} width={'100%'} alignItems={'center'}>
      <Typography sx={{
        display: 'flex',
        flexDirection: 'row',
        alignItems: 'center',
        
      }} color="black"><CalendarMonthIcon sx={{
        pb: 0.2,
      }} fontSize="small" /> Mei 2,3,4 2025</Typography>
      <Typography sx={{
        display: 'flex',
        flexDirection: 'row',
        alignItems: 'center',
        
      }} color="black"><LocationOnIcon sx={{
        pb: 0.2,
      }} fontSize="small" /> 't Frusselt 30, 8076 RE
      Vierhouten, Nederland</Typography>
      </Stack>
    </Stack>
  </Stack>
  )
